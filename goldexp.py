...
with col1:
    st.image(r'venv\media\rcionalizm.jpg', use_container_width=True)
with col2:
    st.image(r'venv\media\numerology.jpg', use_container_width=True)
st.markdown("#### __________________________________________________________")
st.markdown("""
            ...
            """)
st.video(r'venv\media\sheldon73.mp4')
...
with col1:
    st.image(r'venv\media\ch77.jpg', use_container_width=True)
with col2:
    st.image(r'venv\media\def77.jpg', use_container_width=True)
with col3:
    st.image(r'venv\media\palindrom.jpg', use_container_width=True)
with col4:
    st.image(r'venv\media\prikol.jpg', use_container_width=True)
st.markdown("""
            И всё же есть тот, на ком сошлись звёзды. Обладая всем необходимым, он выбрал число 73.
            """)
st.image(r'venv\media\winner.jpg', use_container_width=True)
st.markdown("#### __________________________________________________________")
